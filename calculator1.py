...
@when('Verify that the input field only accept {value_type} type')
def input_field_only_accept_numbers(context, value_type):
    context.app.roi_calculator_page.verify_tag_type(value_type)


@when('click over form {form_section} section')
